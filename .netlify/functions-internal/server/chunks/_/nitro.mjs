...
const _lazy_RjSf3R = () => import('../routes/api/converter.post.mjs');
const _lazy_G6yvfS = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/converter', handler: _lazy_RjSf3R, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_G6yvfS, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_G6yvfS, lazy: true, middleware: false, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\Eduardo Oliveira\\Documents\\dev_projetos\\oracle-to-postgres\\.data\\kv"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "269de3f0-0fe9-4f57-9e20-9a83f72ab959",
